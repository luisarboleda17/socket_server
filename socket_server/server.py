...
# def main(argv=None):
#     parser = argparse.ArgumentParser(description='Process socket server arguments')
#     parser.add_argument('--host', type=str, default='127.0.0.1', help='Listen host')
#     parser.add_argument('--port', type=int, default=5564, help='Listen port')
#     parser.add_argument('--workers', type=int, default=1, help='Workers quantity')
#
...
#
#     @socket_server.json_handler
#     def json_handler(message):
#         logging.debug(f'JSON Handler {message}')
#
#     @socket_server.text_handler
#     def text_handler(message):
#         logging.debug(f'Text Handler {message}')
#
#     @socket_server.event_handler('test')
#     def event_handler(message):
#         logging.debug(f'Event Handler {message}')
#
#         yield {'type': 'prueba', 'content': 'prueba'}
#         time.sleep(5)
#         yield {'event_name': 'test_event', 'event_message': 'Mensaje de prueba'}
#         time.sleep(5)
#         yield 'Probando este mensaje de texto'
#         time.sleep(5)
#         yield 1234567890
#
#     socket_server.start()
